 ...
 * Return: Number of chars printed.
 */
int p_nbr(int is_negative, int ind, char buffer[],
	int flags, int width, int precision, int size)
{
...
/**
 * p_usigned - Writes an unsigned number
...
/**
 * p_point - Write a memory address
